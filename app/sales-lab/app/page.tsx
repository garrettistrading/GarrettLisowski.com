...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/sales-lab/app" },
  twitter: {
    card: "summary",
...
export default async function SalesLabPage({ searchParams }: { searchParams: Promise<{ demo?: string }> }) {
  const { demo } = await searchParams;
  return <SalesLab key={demo === "review" ? "review" : "practice"} initialDemo={demo === "review" ? "review" : "practice"} />;
}
